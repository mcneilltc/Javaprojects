...
public class CornerStore implements Store{
    ...
    public String getName(String name) {
        System.out.println("Welcome to the Circular Corner Store!");
        return name;
    }
    ...
    public String getAddress(String address) {
        System.out.println("The address is 4321 Tom Swifty street");
        return address;
    }
    ...
    public String getSqft(String sqft) {
        System.out.println("The corner store is 2500 square feet. Yeah, we're always packed.");
        return sqft;
    }
}
